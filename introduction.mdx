...
description: "Learn what CSBP is, why it exists, and how it solves the persistent-memory problem for long-lived Codex setups."
---
...
<CardGroup cols={3}>
  <Card title="CSBP-entry-point.txt" icon="door-open">
  ...
  <Card title="shared-best-practice.txt" icon="bookmark">
  ...
  <Card title="shared-best-practice-compiler.txt" icon="flask">
