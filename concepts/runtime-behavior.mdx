...
description: "CSBP reads active practices from shared-best-practice.txt each session and applies them only when their applies_when condition matches the current work."
---
